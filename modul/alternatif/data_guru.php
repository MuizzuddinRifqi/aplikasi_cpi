						...
						<tbody>
							...
							?>
								...
								<tr>
									...
									<td>
										<a href="?module=edit_guru&id_guru=<?php echo $row['id_guru']; ?>" title="Edit Data" class="btn btn-primary btn-sm">
											<i class="nav-icon fas fa-edit"></i>
										</a>

										<a href="?module=data_guru&aksi=delete&id_guru=<?php echo $row['id_guru']; ?>" title="Hapus Data" onclick="return confirm('Anda yakin akan menghapus data <?php echo $row['nm_guru']; ?>?')" class="btn btn-danger btn-sm">
