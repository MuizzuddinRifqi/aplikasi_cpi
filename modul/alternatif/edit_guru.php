						...
						<div class="card-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									<div class="radio">
										<label>
											<input type="radio" name="jenkel" value="Laki-laki" <?php echo ($row['jenkel'] == 'Laki-laki') ? 'checked' : ''; ?>>&nbsp;Laki-laki
										</label>&nbsp;&nbsp;&nbsp;&nbsp;

										<label>
											<input type="radio" name="jenkel" value="Perempuan" <?php echo ($row['jenkel'] == 'Perempuan') ? 'checked' : '' ?>>&nbsp;Perempuan
										</label>
									</div>
								</div>
							</div>
