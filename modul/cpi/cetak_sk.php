		...
		<div class="row">
			<div class="col-12">
				<div class="card card-secondary">
					...
					<div class="form-group">
						<div class="col-sm-12">
							<input type="button" onClick="getDataSK()" name="" class="btn btn-primary" value="Tampil">
						</div>
					</div>
				</div>
				<?php
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<input type="button" name="Add Nilai" class="btn btn-primary" onClick="simpan_sk('<?php echo $row['id_kinerja']; ?>')" style="margin-top: 10px" value="Cetak SK">
											</td>
										</tr>
