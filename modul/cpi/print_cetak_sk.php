...
<body>
    <div class="header">
        <p class="title2">ALIYAMAHIKA</p>
        <span>Putat Utara, Putat, Kec. Tanggulangin, Kabupaten Sidoarjo, Jawa Timur 61272</span>
        <div class="garis"></div>
    </div>
    <hr>
    <div class="content">
        ...
        <div style="float: right; margin-right: 30px; text-align: center;">
            ...
            <p style="float: right; margin-right: 30px; text-align: center;"> H. Riza Rifqy, M.Pd</p>
        </div>
    </div>
</body>
