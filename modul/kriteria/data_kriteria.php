...
{
	global $koneksi;
	$result = mysqli_query($koneksi, "SELECT SUM(bobot) as total FROM kriteria");
		...
		<div class="col-12">
			...
			<div class="card">
				<div class="card-header">
					<a href="?module=input_kriteria" class="btn btn-primary" onclick="return checkTotalWeight();">Tambah Data</a>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
						...
						<tbody>
							...
							<script>
								function checkTotalWeight() {
									var totalWeight = <?php echo getTotalWeight(); ?>;									
									var updatedTotal = totalWeight;

									if (updatedTotal >= 100) {
										alert('Total Bobot Sudah Mencapai 100%, Bobot Sekarang (' + updatedTotal + '%). Kurangi Bobot Kriteria Lainnya Terlebih Dahulu');
										return false;
									}
